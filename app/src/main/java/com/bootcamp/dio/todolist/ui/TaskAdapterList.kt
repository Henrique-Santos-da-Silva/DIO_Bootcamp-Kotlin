...
import com.bootcamp.dio.todolist.R
import com.bootcamp.dio.todolist.databinding.ItemTaskBinding
import com.bootcamp.dio.todolist.model.Task

class TaskAdapterList: ListAdapter<Task, TaskAdapterList.TaskViewHolder>(DiffCallback()) {
